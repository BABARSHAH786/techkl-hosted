    ...
    return(
        <section>
            <div className="max-ss:w-[412px] max-ss:ml-0 ml-[230px] ">
                <div className="max-ss:w-[12px]  text-center text-[32px] leading-[36px] font-medium text-[#111111] ">Code with Speed</div>
                ...
                <p className="mt-3">My name is Syed babar ali . I m we developer</p>
