...
<button className="w-[110px ] h-[39px] ml-4 bg-[#111111] rounded-[30px] py-[7px] px-[22px]  ">Shop NIKE</button>           </Link>
                ...
                <Image src="/img1.jpeg" alt="AI Image" width={500} height={500} className="w-full h-auto mt-4" />
                <Image src="/img2.jpeg" alt="AI Image" width={500} height={500} className="w-full h-auto mt-4" />
                <Image src="/ing3.jpeg" alt="AI Image" width={500} height={500} className="w-full h-auto mt-4" />
