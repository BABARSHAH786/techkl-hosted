...
const ColabQuiz = () => {
  ...
  //   return selectedAnswers[qIndex] === option && option === questions[qIndex].answer;
  // };

  return (
    <div style={{ padding: "2rem" }}>
      <h1>Google Colab MCQ Quiz</h1>
          ...
          {q.options.map((option, oIndex) => (
            <div key={oIndex}>
              <label style={{ cursor: "pointer" }}>
                ...
                {showResults && selectedAnswers[index] === option && option !== q.answer && (
      ...
      <button onClick={() => setShowResults(true)} style={{ padding: "10px 20px", fontSize: "16px" }}>
        Submit Answers
      </button>
    </div>
  );
